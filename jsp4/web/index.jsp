...
<script type="text/javascript">
    ...
    var snake =<%=snakePoints%>;
    var cherries = <%=cherryPoints%>;
    var rocks = <%=rocksPoints%>;
    ...
    function drawSnake() {
        snake.forEach( x => drawSnakeSquare(x.x, x.y));

    }

    function drawCherry() {
        cherries.forEach( x => drawCherrySquare(x.x, x.y));
    }

    function drawRocks() {
        rocks.forEach( x => drawRockSquare(x.x, x.y));
    }
